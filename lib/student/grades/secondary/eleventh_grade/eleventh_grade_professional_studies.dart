...
class ProfessionalStudies extends StatefulWidget {
  @override
  _ProfessionalStudiesState createState() => _ProfessionalStudiesState();
}

class _ProfessionalStudiesState extends State<ProfessionalStudies> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text('Eleventh grade-Professional Studies',
