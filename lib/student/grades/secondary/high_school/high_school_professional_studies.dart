...
class HighSchoolProfessionalStudies extends StatefulWidget {
  @override
  _HighSchoolProfessionalStudiesState createState() =>
      _HighSchoolProfessionalStudiesState();
}

class _HighSchoolProfessionalStudiesState
    extends State<HighSchoolProfessionalStudies> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text('High School-Professional Studies',
