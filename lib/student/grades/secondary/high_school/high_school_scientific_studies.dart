...
class HighSchoolScientificStudies extends StatefulWidget {
  @override
  _HighSchoolScientificStudiesState createState() =>
      _HighSchoolScientificStudiesState();
}

class _HighSchoolScientificStudiesState
    extends State<HighSchoolScientificStudies> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text('High School-Scientific Studies',
