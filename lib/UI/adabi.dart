...
class MajorAdabiPage extends StatefulWidget {
  @override
  _MajorAdabiPageState createState() => _MajorAdabiPageState();
}

class _MajorAdabiPageState extends State<MajorAdabiPage> {
  @override
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ListView(children: <Widget>[
                    ...
                    InkWell(
                      child: _bulidlevelItem("عربي تخصص", "المواد"),
                      onTap: () {},
                    ),
                    InkWell(
                      child: _bulidlevelItem("تاريخ العرب", "المواد"),
                      onTap: () {},
                    ),
                    InkWell(
                    ...
                    InkWell(
                      child: _bulidlevelItem("الجفرافيا", "المواد"),
                      onTap: () {},
                    ),
                    InkWell(
                    ...
                    InkWell(
                      child: _bulidlevelItem("ثقافة مالية", "المواد"),
                      onTap: () {},
                    ),
                  ]),
                ),
