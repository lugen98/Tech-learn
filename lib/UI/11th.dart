...
class _ElevenPageState extends State<ElevenPage> {
                  ...
                  child: ListView(
                      ...
                      children: <Widget>[
                        InkWell(child: _bulidlevelItem(
                            "أدبي","المواد"),onTap:(){ Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => MajorAdabiPage()));
                        },),
                        InkWell(child: _bulidlevelItem(
                            "علمي","المواد"),
                            onTap: openelmePage),
  ...
  void openelmePage() {
    ...
    Navigator.push(context, MaterialPageRoute(builder: (context) =>MajoPage()));
  }
