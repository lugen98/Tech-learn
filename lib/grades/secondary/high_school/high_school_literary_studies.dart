...
class HighSchoolLiteraryStudies extends StatefulWidget {
  @override
  _HighSchoolLiteraryStudiesState createState() => _HighSchoolLiteraryStudiesState();
}

class _HighSchoolLiteraryStudiesState extends State<HighSchoolLiteraryStudies> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:
            ...
            Text('High School-Literary Studies',
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: ListView(children: <Widget>[
                  ...
                  InkWell( child: _bulidlevelItem("Islamic Education"),
                    onTap: () { Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => ChooseTeacher()));},),
                  ...
                  InkWell( child: _bulidlevelItem("English"),
                    onTap: () { Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) => ChooseTeacher()));},),
                  InkWell( child: _bulidlevelItem("Modern And Contemporary\nArab History"),
                    onTap: () { Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => ChooseTeacher()));},),
                  InkWell( child: _bulidlevelItem("Arabic Specialty"),
                    onTap: () { Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => ChooseTeacher()));},),
